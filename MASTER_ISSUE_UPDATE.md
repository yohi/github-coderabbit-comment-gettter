...
## 📋 更新理由
マスターIssueに具体的なIssue番号（#7-#14）が記載されていないため、AIエージェントが具体的にどのIssueを対応すべきかわからない状態でした。

## 🔄 更新手順
以下の内容でマスターIssue (#6) を手動更新してください：

---

# 🎯 GitHub Review Prompts AI Agent - 改善ロードマップ 2025
...
マスターIssue (#6) を上記内容で更新した後、以下を確認してください：

1. **リンクの動作確認**: 各Issue (#7-#14) へのリンクが正しく機能するか
2. **AIエージェント向け指示の明確性**: 新しいセッション開始時の手順が明確か
3. **進捗管理の実用性**: 進捗更新が容易に行えるか

これで新しいセッションのAIエージェントが、具体的にどのIssueから取り組むべきかを即座に理解できるようになります。
