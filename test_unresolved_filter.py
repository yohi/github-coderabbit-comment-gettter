...
from github_review_prompts.github_client import GitHubClient, GitHubPRInfo
...
def test_unresolved_filter():
    ...
    pr_info = GitHubPRInfo(owner="yohi", repo="CursorCLI-Extensions", pull_number=12)

    print("📊 未解決インラインコメントフィルタテスト")
    print(
        f"🎯 対象PR: https://github.com/{pr_info.owner}/{pr_info.repo}/pull/{pr_info.pull_number}"
    )
