...
class GitHubCurlReply:
    ...
    def _run_curl(self, method: str, url: str, data: Optional[Dict] = None) -> Tuple[Dict, int]:
        """
    ...
    def reply_to_review_comment(self, owner: str, repo: str, comment_id: int, reply_text: str) -> Dict:
        """
        レビューコメントに返信
    ...
    def create_pr_comment(self, owner: str, repo: str, pr_number: int, comment_text: str) -> Dict:
        """
        PR全体に対する新しいコメントを作成
    ...
    def batch_reply(self, owner: str, repo: str, replies: List[Dict[str, Union[str, int]]]) -> List[Dict]:
        """
        複数のコメントに一括返信
        ...
        for i, reply_info in enumerate(replies, 1):
            ...
            try:
                ...
                result = self.reply_to_review_comment(owner, repo, comment_id, reply_text)
